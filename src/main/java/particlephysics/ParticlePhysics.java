...
@Mod(modid = ParticlePhysics.ID, name = ParticlePhysics.NAME, version = ParticlePhysics.VERSION_FULL, useMetadata = false, acceptedMinecraftVersions = "[1.7.10,)", dependencies = "required-after:Forge@[10.13.2.1291,)")
public class ParticlePhysics
{
     ...
     */
    @Mod.Metadata(ParticlePhysics.ID)
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        metadata.modId = ParticlePhysics.ID;
        metadata.name = ParticlePhysics.NAME;
        metadata.description = ParticlePhysics.NAME + " a mod that lets you mess around and have fun to create a unique power plant.";
        metadata.url = "http://jakimfett.com/ParticlePhysics";
        metadata.logoFile = "assets/" + ParticlePhysics.ID + "/logo.png";
        metadata.version = ParticlePhysics.V_MAJOR + "." + ParticlePhysics.V_MINOR;
